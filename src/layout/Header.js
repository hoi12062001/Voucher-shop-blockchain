                ...
                <nav class="navbar navbar-expand-lg navbar-light bg-light">
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul class="navbar-nav mr-auto">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="https://solana.com/vi/events">Sự kiện</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="https://solana.com/vi/docs">Xây dựng</a>
                            </li>
                        </ul>
                        <form class="form-inline my-2 my-lg-0">
                            <div class="search_icon"><a href="/" ><img src="images/search-icon.png" alt="" /></a></div>
                        </form>
                    </div>
                </nav>
            </div>
